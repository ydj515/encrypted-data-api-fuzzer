@service=reservation @api=getResourceSchedules @kind=single-api
Feature: orgA reservation 자원 스케줄 조회(본문 기반) 단건 API 테스트
  ...
  Scenario: OpenAPI maxLength 필드 resourceId 최대 길이 초과 시 400 반환
    Given path basePath + '/getResourceSchedules'
    And request { resourceId: 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', from: '2026-02-26T09:00:00+09:00', to: '2026-02-26T18:00:00+09:00' }
    When method POST
    Then status 400
